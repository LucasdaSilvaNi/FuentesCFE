...
{
    public class HistorialCargosAcumuladosSubReportHandler : IReportViewerEventsHandler
    {
        public void OnSubreportProcessing(ReportViewer reportViewer, SubreportProcessingEventArgs e)
        {
            var data = TiempoEnProcesoHelper.Helper.passData[TiempoEnProcesoHelper.Helper.empleado + "_HistorialCargos"];
