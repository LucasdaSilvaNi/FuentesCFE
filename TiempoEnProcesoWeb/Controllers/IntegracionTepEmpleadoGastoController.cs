...
{
    public class IntegracionTepEmpleadoGastoController : Controller
    {
        //
        // GET: /AuxiliarTep/
        ...
        {
            IntegracionTepEmpleadoGastoModel _model = new IntegracionTepEmpleadoGastoModel();
            ...
            _model.Anio = _oficina.periodo_proceso.Substring(3, 4);
            _model.Periodo = DateTime.Now.Date.ToString("MM");
        ...
        public ActionResult Generate(Models.IntegracionTepEmpleadoGastoModel _model)
        {
            ...
            _rpt.Data = (new ReportesBL()).Reporte_Integracion_Tep_Empleado_Gasto(_oficina.id_oficina, _model.Cliente, _model.Servicio, _model.Job, _model.Anio, _model.Periodo);
