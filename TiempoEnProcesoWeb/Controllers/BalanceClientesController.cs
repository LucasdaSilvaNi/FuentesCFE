...
{
    public class BalanceClientesController : Controller
    {
        //
        // GET: /AuxiliarTep/
        ...
        {
            BalanceClientesModel _model = new BalanceClientesModel();
        ...
        public ActionResult Generate(Models.BalanceClientesModel _model)
        {
            ...
            _rpt.Data = (new ReportesBL()).Reporte_Balance_Antiguedad(_oficina.id_pais, dt, ordenadopor, _oficina.id_oficina, _model.Socio, _model.Encargado,_model.Cliente);

            TiempoEnProcesoHelper.Helper.SetData((new ReportesBL()).Reporte_Balance_Antiguedad_SubPre(_oficina.id_pais, dt, ordenadopor, _oficina.id_oficina, _model.Socio, _model.Encargado, _model.Cliente), "_BalAntPrel");
            TiempoEnProcesoHelper.Helper.SetData((new ReportesBL()).Reporte_Balance_Antiguedad_SubDef(_oficina.id_pais, dt, ordenadopor, _oficina.id_oficina, _model.Socio, _model.Encargado, _model.Cliente), "_BalAntDef");            
