...
{
    public class SumarioFacturacionController : Controller
    {
        //
        // GET: /AuxiliarTep/
        ...
        {
            SumarioFacturacionModel _model = new SumarioFacturacionModel();
        ...
        public ActionResult Generate(Models.SumarioFacturacionModel _model)
        {
            ...
            string ordenadopor = _model.EsGerente == 1 ? TiempoEnProcesoHelper.Constantes.ORD_GERENTE_SOCIO.Substring(0, 1) : TiempoEnProcesoHelper.Constantes.ORD_SOCIO_GERENTE.Substring(0, 1);
            string salta = "S";
            ...
            _rpt.Data = (new ReportesBL()).Reporte_Sumario_Facturacion(_oficina.id_pais, periodo, ordenadopor, salta,  _oficina.id_oficina, _model.Socio, _model.Encargado);
            _rpt.EsSocio = _model.EsGerente != 1;

            TiempoEnProcesoHelper.Helper.SetData(_rpt.Data, "_SumFact");            
