...
{
    public partial class frmRpt_Cumpleanios : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_Cumpleanios()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                int _estado = Convert.ToInt32(uceEstado.Value);


                List<rpt_listado_cumpleanios_Result> lst = db.rpt_listado_cumpleanios(Helper.Oficina, _estado).ToList<rpt_listado_cumpleanios_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_listado_cumpleanios_Result>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._parameters.Add("oficina", Helper.Oficina);
                frm._parameters.Add("Mes", _estado.ToString());
                frm._reportName = "Rpt_listado_cumpleanios.rdlc";
        ...
        private void frmRegion_Load(object sender, EventArgs e)
        {
            ...
            uceEstado.Value = DateTime.Now.Month;
            CargaCombos();
