...
{
    public partial class frmRpt_ValidacionFacturasAnuladas : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_ValidacionFacturasAnuladas()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_validacion_facturas_anuladas_Result> lst = db.rpt_validacion_facturas_anuladas(Helper.Oficina, _entidad, dtI, dtF).ToList<rpt_validacion_facturas_anuladas_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_validacion_facturas_anuladas_Result>(lst);
                ...
                frm._data = dsData;
                frm._reportName = "rpt_validacion_facturas_anuladas.rdlc";
