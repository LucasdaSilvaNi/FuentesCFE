...
{
    public partial class frmRpt_ValidacionFacturasPorGenerar : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_ValidacionFacturasPorGenerar()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_validacion_facturas_por_generar_cxc_Result> lst = db.rpt_validacion_facturas_por_generar_cxc(Helper.Oficina).ToList<rpt_validacion_facturas_por_generar_cxc_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_validacion_facturas_por_generar_cxc_Result>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._reportName = "rpt_validacion_facturas_por_generar_cxc.rdlc";
