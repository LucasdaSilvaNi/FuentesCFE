...
{
    public partial class frmRpt_CatalogoServicios : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_CatalogoServicios()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_catalogo_servicios_Result> lst = db.rpt_catalogo_servicios().ToList<rpt_catalogo_servicios_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_catalogo_servicios_Result>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._reportName = "catalogo_servicios.rdlc";
