...
{
    public partial class frmRpt_ListadoHonorariosCargados : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_ListadoHonorariosCargados()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_listado_honorarios_cargados_Result> lst = db.rpt_listado_honorarios_cargados(Helper.Pais, (Helper.OficinaActiva as tbl_oficina).periodo_proceso).ToList<rpt_listado_honorarios_cargados_Result>();
