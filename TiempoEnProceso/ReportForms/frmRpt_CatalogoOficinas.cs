...
{
    public partial class frmRpt_CatalogoOficinas : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_CatalogoOficinas()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<tbl_oficina> lst = db.tbl_oficina.ToList();
                ...
                DataSet dsData = Helper.ToDataSet<tbl_oficina>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._reportName = "catalogo_oficinas.rdlc";
