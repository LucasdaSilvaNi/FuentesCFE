...
{
    public partial class frmRpt_ClientesSinMovimiento : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_ClientesSinMovimiento()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_listado_clientes_sin_movimiento_Result> lst = db.rpt_listado_clientes_sin_movimiento(ucOficina.Value.ToString()).ToList<rpt_listado_clientes_sin_movimiento_Result>();
                ...
                dsData = Helper.ToDataSet<rpt_listado_clientes_sin_movimiento_Result>(lst);
               
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._parameters.Add("Pais", ucOficina.Value.ToString());

                frm._data = dsData;
                frm._reportName = "rpt_listado_clientes_sin_movimiento.rdlc";
        ...
        private void frmRegion_Load(object sender, EventArgs e)
        {
            ...
            ucOficina.Value = (Helper.OficinaActiva as tbl_oficina).id_pais;
        }
