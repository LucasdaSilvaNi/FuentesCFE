...
{
    public partial class frmRpt_ValidacionCobranzaNC : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_ValidacionCobranzaNC()
        {
            InitializeComponent();
        ...
        private void frmRegion_Load(object sender, EventArgs e)
        {
            ...
            uccFechaInicial.Value =(new PeriodoBL()).PorId((Helper.OficinaActiva as tbl_oficina).periodo_proceso);
