...
{
    public partial class frmRpt_CatalogoJob : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_CatalogoJob()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                int _estado = 99;
                if (uceEstado.Value != null)
                    _estado = Convert.ToInt32(uceEstado.Value);


                List<rpt_jobs_Result> lst = db.rpt_jobs((Helper.OficinaActiva as tbl_oficina).id_pais, _estado).ToList<rpt_jobs_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_jobs_Result>(lst);
                ...
                frm._reportName = "rpt_jobs_activos_inactivos.rdlc";
