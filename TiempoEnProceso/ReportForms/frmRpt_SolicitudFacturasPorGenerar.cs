...
{
    public partial class frmRpt_SolicitudFacturasPorGenerar : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_SolicitudFacturasPorGenerar()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_facturas_por_generar_Result> lst = db.rpt_facturas_por_generar(Helper.Oficina, DateTime.Now.Date).ToList<rpt_facturas_por_generar_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_facturas_por_generar_Result>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._reportName = "rpt_facturas_por_generar.rdlc";
