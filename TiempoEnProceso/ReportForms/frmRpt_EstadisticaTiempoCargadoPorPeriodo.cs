...
{
    public partial class frmRpt_EstadisticaTiempoCargadoPorPeriodo : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_EstadisticaTiempoCargadoPorPeriodo()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                {
                    List<rpt_estadistica_tiempo_cargado_proc_periodo_Result> lst = db.rpt_estadistica_tiempo_cargado_proc_periodo(Helper.Oficina, ucPeriodo.Value.ToString(), ucPeriodoFinal.Value.ToString()).ToList<rpt_estadistica_tiempo_cargado_proc_periodo_Result>();
                    ...
                    dsData = Helper.ToDataSet<rpt_estadistica_tiempo_cargado_proc_periodo_Result>(lst);
                    _reporte = "rpt_estadistica_tiempo_cargado_periodo";
                }
                else
                {
                    List<rpt_estadistica_tiempo_teams_periodo_Result> lst = db.rpt_estadistica_tiempo_teams_periodo(Helper.Oficina, ucPeriodo.Value.ToString(), ucPeriodoFinal.Value.ToString()).ToList<rpt_estadistica_tiempo_teams_periodo_Result>();
                    ...
                    dsData = Helper.ToDataSet<rpt_estadistica_tiempo_teams_periodo_Result>(lst);
                    _reporte = "rpt_estadistica_tiempo_cargado_team_periodo";
                }
                ...
                frm._parameters.Add("Periodo_inicial", ucPeriodo.Value.ToString());
                frm._parameters.Add("Periodo_final", ucPeriodo.Value.ToString());
        ...
        private void frmRegion_Load(object sender, EventArgs e)
        {
            ...
            ucPeriodoFinal.Value = (Helper.OficinaActiva as tbl_oficina).periodo_proceso;
