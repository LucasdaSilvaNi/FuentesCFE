...
{
    public partial class frmRpt_CatalogoIndustrias : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_CatalogoIndustrias()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_catalogo_industrias_Result> lst = db.rpt_catalogo_industrias().ToList<rpt_catalogo_industrias_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_catalogo_industrias_Result>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._reportName = "catalogo_industrias.rdlc";
