...
{
    public partial class frmRpt_CatalogoGastosAdmin : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_CatalogoGastosAdmin()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_catalogo_gastos_administrativos_Result> lst = db.rpt_catalogo_gastos_administrativos().ToList<rpt_catalogo_gastos_administrativos_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_catalogo_gastos_administrativos_Result>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._reportName = "catalogo_gastos_administrativos.rdlc";
