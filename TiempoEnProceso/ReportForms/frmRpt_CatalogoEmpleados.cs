...
{
    public partial class frmRpt_CatalogoEmpleados : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_CatalogoEmpleados()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                string _estado = "T";
                if (uceEstado.Value != null)
                    _estado = uceEstado.Value.ToString();


                List<rpt_catalogo_empleados_Result> lst = db.rpt_catalogo_empleados((Helper.OficinaActiva as tbl_oficina).id_oficina, _estado).ToList<rpt_catalogo_empleados_Result>();
                ...
                DataSet dsData = Helper.ToDataSet<rpt_catalogo_empleados_Result>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._reportName = "catalogo_empleados.rdlc";
