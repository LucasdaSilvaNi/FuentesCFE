...
{
    public partial class frmRpt_LibroVentasContriES : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_LibroVentasContriES()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<rpt_libro_ventas_salvadoreño_Result> lst = db.rpt_libro_ventas_salvadoreño(Helper.Oficina, _mes, _anio, "VENTAS A CONTRIBUYENTES").ToList();
                ...
                List<rpt_libro_ventas_salvadoreño_resumen_Result> lstS = db.rpt_libro_ventas_salvadoreño_resumen(Helper.Oficina, _mes, _anio, "VENTAS A CONTRIBUYENTES").ToList();
                ...
                frm._parameters.Add("tipo_reporte", "VENTAS A CONTRIBUYENTES");
                frm._data = dsData;
                frm._reportName = "rpt_libro_ventas_salvadoreño_ventas_a_contribuyentes.rdlc";
