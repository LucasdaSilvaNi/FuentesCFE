...
{
    public partial class frmRpt_CatalogoPaises : Form
    {
        private TEPEntities db= new TEPEntities(Helper.CadenaConexion);

        public frmRpt_CatalogoPaises()
        {
            InitializeComponent();
        ...
        private bool Grabar()
        {
            ...
            try
            {
                ...
                List<tbl_paises> lst = db.tbl_paises.ToList();
                ...
                DataSet dsData = Helper.ToDataSet<tbl_paises>(lst);
                dsData.Tables[0].TableName = "pwcia";

                frmViewReport frm = new frmViewReport();
                frm._data = dsData;
                frm._reportName = "catalogo_paises.rdlc";
