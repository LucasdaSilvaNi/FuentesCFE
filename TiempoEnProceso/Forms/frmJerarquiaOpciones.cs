...
{
    public partial class frmJerarquiaOpciones : Form
    {
        ...
        private List<tbl_opciones_puesto> lstO;

        private TEPEntities db;

        public frmJerarquiaOpciones()
        {
            InitializeComponent();
        ...
        public void CargarItem(string _puesto)
        {
            ...
            lstO = db.tbl_opciones_puesto.Where(d => d.id_puesto == Item.id_puesto).ToList<tbl_opciones_puesto>();
        ...
        private void ConstruyeItem()
        {
            ...
            foreach (tbl_opciones_puesto _op in (List<tbl_opciones_puesto>)ugDataPermisos.DataSource)
            {
                if (!db.tbl_opciones_puesto.Any(d => d.id_puesto == _op.id_puesto && d.menu == _op.menu && d.opcion == _op.opcion))
                    db.tbl_opciones_puesto.Add(_op);
            }
        }
        ...
        private void btAgregar_Click(object sender, EventArgs e)
        {
                ...
                ucOpcion.SelectedRow != null)
            {
                 ...
                 if (!lstO.Any(d => d.id_puesto == _o && d.menu == op.menu && d.opcion == op.opcion))
                 {
                     tbl_opciones_puesto _opU = new tbl_opciones_puesto();
                     _opU.id_puesto = uteID.Value.ToString();
                     _opU.menu = op.menu;
        ...
        {
            tbl_opciones_puesto _tb=e.Cell.Row.ListObject as tbl_opciones_puesto;

            if (db.tbl_opciones_puesto.Any(d => d.id_puesto == _tb.id_puesto && d.menu == _tb.menu && d.opcion == _tb.opcion))
                db.tbl_opciones_puesto.Remove(e.Cell.Row.ListObject as tbl_opciones_puesto);
            lstO.Remove(e.Cell.Row.ListObject as tbl_opciones_puesto);
            ugDataPermisos.DataBind();
        }
